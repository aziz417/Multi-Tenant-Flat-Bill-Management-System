        ...
        <form action="{{ route('house-owner.flats.update', $flat) }}" method="POST">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('flat_number') is-invalid @enderror" 
                               id="flat_number" name="flat_number" value="{{ old('flat_number', $flat->flat_number) }}" required>
                        @error('flat_number')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('floor_number') is-invalid @enderror" 
                               id="floor_number" name="floor_number" value="{{ old('floor_number', $flat->floor_number) }}" min="0" required>
                        @error('floor_number')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('flat_owner_name') is-invalid @enderror" 
                       id="flat_owner_name" name="flat_owner_name" value="{{ old('flat_owner_name', $flat->flat_owner_name) }}" required>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('bedrooms') is-invalid @enderror" 
                               id="bedrooms" name="bedrooms" value="{{ old('bedrooms', $flat->bedrooms) }}" min="1" required>
                        @error('bedrooms')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('monthly_rent') is-invalid @enderror" 
                               id="monthly_rent" name="monthly_rent" value="{{ old('monthly_rent', $flat->monthly_rent) }}" min="0">
                        @error('monthly_rent')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
